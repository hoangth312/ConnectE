...
//        NSString *mediaURLString = [ConnectUtil urlEncode:mediaURL.absoluteString]; // content path
//        NSString *titleString = title ? [ConnectUtil urlEncode:title] : @"(null)"; // video name
//        NSString *mediaTypeString = ensureString(mediaType); // video format
//
//        NSString *applicationPath = [NSString stringWithFormat:@"15985?t=v&h=a&u=%@&k=%@&videoName=%s&videoFormat=%s",
//                                     mediaURLString,
//                                     titleString,
//                                     [mediaTypeString UTF8String],
//                                     [mediaTypeString UTF8String]];
    } else
    {
